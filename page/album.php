            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if ($submit=='Simpan') {
                       ...
                       $insert=mysqli_query($conn, "INSERT INTO album VALUES('','$nama_album','$deskripsi_album','$tanggal','$userid')");
                       if ($insert) {
                    ...
                    <form action="?url=album" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" require name="nama_album">
                        </div>
                        <div class="form-group">
                            <label>Deskripsi Album</label>
                            <textarea name="deskripsi_album" class="form-control" require cols="30" rows="5"></textarea>
                        </div>
                    ...
                    <?php elseif(isset($_GET['edit'])): ?>
                        ...
                        <div class="form-group">
                            <label>Nama Album</label>
                            <input type="text" class="form-control" value="<?= $val['NamaAlbum'] ?>" require name="nama_album">
                        </div>
                        <div class="form-group">
                            <label>Deskripsi Album</label>
                            <textarea name="deskripsi_album" class="form-control" require cols="30" rows="5"><?= $val['Deskripsi'] ?></textarea>
                        </div>
                ...
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            $i=1;
                            $userid=@$_SESSION['userid'];
                            $albums=mysqli_query($conn, "SELECT * FROM album"); // ini untuk menampilkan semua data
