<div class="container my-4 p-5 bg-hero rounded">
    <div class="py-5 text-white">
       ...
       <p class="fs-4 col-md-8">`Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi totam libero sed corporis officia eligendi aperiam autem hic mollitia fuga.</p>
    </div>
</div>
<div class="container">
    <div class="row">
